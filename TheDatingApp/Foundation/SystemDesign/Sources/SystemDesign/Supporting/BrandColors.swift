...
public enum BrandColors {
    ...
    public static var primaryGradientColors: [Color] {
        [primaryPink, secondaryPurple]
    }
    
    public static var flameGradientColors: [Color] {
        [flameTop, flameBottom]
    }
    
    public static var likeGradientColors: [Color] {
        [likeGradientStart, likeGradientEnd]
    }
    ...
    public static var primaryGradient: LinearGradient {
        LinearGradient(
            gradient: Gradient(colors: primaryGradientColors),
    ...
    public static var flameGradient: LinearGradient {
        LinearGradient(
            gradient: Gradient(colors: flameGradientColors),
            startPoint: .top,
            endPoint: .bottom
        )
    }
    ...
    public static var likeGradient: LinearGradient {
        LinearGradient(
            gradient: Gradient(colors: likeGradientColors),
            startPoint: .topLeading,
            endPoint: .bottomTrailing
        )
    }
